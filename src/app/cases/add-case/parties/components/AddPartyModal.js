    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Username */}
          <div className="space-y-2">
            <Label htmlFor="case-party-username">{t('parties.username') || 'اسم المستخدم'}</Label>
            <Input
              id="case-party-username"
          ...
          {/* Password */}
          <div className="space-y-2">
            <Label htmlFor="case-party-password">{t('parties.password') || 'كلمة المرور'}</Label>
            <Input
              id="case-party-password"
              type="password"
