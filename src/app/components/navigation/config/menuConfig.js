...
export const getMenuItems = (t, userRole = null, userDepartment = null, permissions = [], options = {}) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      type: 'category',
      submenu: [
        { id: 'finance/accounts', label: t('navigation.accounts'), icon: List, requiredPermissions: PERMISSION_REQUIREMENTS.financeLedger },
        { id: 'finance/ledger', label: t('navigation.ledger'), icon: FileText, requiredPermissions: PERMISSION_REQUIREMENTS.financeLedger },
        { id: 'finance/reports', label: t('navigation.reports'), icon: BarChartIcon, requiredPermissions: PERMISSION_REQUIREMENTS.financeStatistics },
        { id: 'finance/budgeting', label: t('navigation.budgeting'), icon: Clock, requiredPermissions: PERMISSION_REQUIREMENTS.financeStatistics },
